      ...
      <section
        ...
        <div className="container mx-auto space-y-10 pb-32 md:pb-0">
          ...
          <ItemContainer
            ...
            description={`Ready to take the leap into the unknown? We're on the hunt for the bold and the dreamers – those who dare to ask, "What if?" If you've got a heart full of aspiration and a dash of "Galactic Calvin," we need you on our cosmic team.`}
            position="left"
          />
        </div>
      </section>
...
const ItemContainer = ({ id, title, description, position, content }: any) => (
  <div className="grid grid-cols-1 md:grid-cols-2">
    ...
    <div className="text-center space-y-5 px-5">
      ...
      <h2
        className={clsx(
          "text-indigo-400 text-2xl font-semibold",
          FONT_P22_MAKINAC_PRO_BOLD.className,
        )}
      >
        {title}
