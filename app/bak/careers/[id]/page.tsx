    ...
    <main>
      <div className="w-full md:w-[1000px] mx-auto px-5 md:px-0">
        ...
        <div className="flex flex-col justify-center items-center space-y-5 mb-20">
          <button className="px-10 py-2 border rounded-full bg-indigo-400 hover:bg-indigo-600 text-white font-semibold">
            I want to apply for this position
          </button>
          <Link
            href="/careers"
            className="flex items-center space-x-3 text-black text-sm"
          >
            <ArrowLeft size={15} />
